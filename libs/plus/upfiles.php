...
{ 
	if( unlink($_GET['del']))
	{
		echo '<script type="text/javascript">alert("删除成功!"); location.href="upfiles.php";</script>';
	}else{
		echo "删除失败!";
	}
}
